...
canvas = tk.Canvas(root, width=800, height=200, bg="pink")
canvas.pack()
rectangle = canvas.create_rectangle(0, 0, 800, 200, fill="pink")
...
low_freq = 300
high_freq = 6000
freq_count_band = np.linspace(low_freq, high_freq, num=rectangle_len, dtype=int)
